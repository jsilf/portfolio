      ...
      <section className="p-standard" id="about">
        <div className="display-flex align-center justify-center">
          <div className="text-block">
            ...
            <p>
              I am currently studying to become a frontend developer by summer
              2023. So far I have learned a lot about problem solving, how to
              plan and design my own projects, work with git in groups, and
              build websites with libraries and frameworks. Love learning new
              things, but also work on getting better at what I already know.
            </p>
            <p>
              Tech I work with is HTML5, CSS3/SCSS, JavaScript, TypeScript,
              Node.js. Frameworks and libraries such as React.js, Next.js,
              Express.js, Angular. Databases MongoDB and MySQL.
            </p>
          </div>
          <section className="text-block-list">
            <h3 className="p-2">experience and education</h3>
